      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            role="menu"
            className="absolute inset-x-3 top-full mt-2 sm:inset-x-auto sm:right-0 sm:top-full sm:mt-2 w-auto sm:w-84 bg-neutral-900/95 backdrop-blur-2xl border border-white/10 rounded-3xl shadow-2xl overflow-hidden z-[1000] divide-y divide-white/10 max-h-[75vh] sm:max-h-[85vh] overflow-y-auto"
          >
            {/* Header / User Info */}
