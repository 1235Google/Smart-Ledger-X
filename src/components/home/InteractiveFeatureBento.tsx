    ...
    <div className="space-y-6 select-none">
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-5 relative z-10">
        ...
        <motion.div 
          ...
          className="md:col-span-7 rounded-[22px] sm:rounded-[30px] vision-glass-elevated p-4 sm:p-7 md:p-8 relative overflow-hidden group shadow-xl"
        >
          {/* Top Specular Rim */}
          ...
          <div className="flex items-start justify-between mb-4 sm:mb-6 relative z-10">
            <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-2xl bg-[#bf5af2]/20 border border-[#bf5af2]/35 flex items-center justify-center text-[#bf5af2] shadow-sm">
              <PiggyBank size={22} />
            </div>
            <span className="px-2.5 py-0.5 sm:px-3 sm:py-1 rounded-full text-[10px] font-bold uppercase tracking-wider text-[#bf5af2] bg-[#bf5af2]/10 border border-[#bf5af2]/25">
              Micro-Savings Vault
            </span>
          </div>

          <h3 className="text-lg sm:text-2xl font-extrabold text-white tracking-tight relative z-10">Smart Gullak Auto-Sweep</h3>
          ...
          <div className="mt-5 sm:mt-6 p-3.5 sm:p-4 rounded-2xl vision-glass border-white/[0.08] flex items-center justify-between relative z-10">
            <div className="flex items-center gap-2.5 sm:gap-3">
              <div className={`w-2.5 h-2.5 rounded-full shrink-0 ${hasGullakData ? 'bg-[#30d158] shadow-[0_0_8px_#30d158]' : 'bg-[#86868b]'}`} />
              <div className="min-w-0">
                <div className="text-xs font-bold text-white">Savings Target</div>
                <div className="text-[10.5px] sm:text-[11px] text-[#86868b] truncate">
                  {hasGullakData 
            ...
            <span className="text-sm sm:text-base font-extrabold text-[#30d158] font-mono shrink-0 ml-2">
          ...
          <Link
            to="/gullak"
            className="inline-flex items-center gap-1.5 text-xs font-bold text-[#bf5af2] hover:text-white mt-5 sm:mt-6 group-hover:translate-x-1 transition-all relative z-10"
          >
        ...
        <motion.div 
          whileHover={{ y: -4, scale: 1.008 }}
          className="md:col-span-5 rounded-[22px] sm:rounded-[30px] vision-glass-elevated p-4 sm:p-7 md:p-8 relative overflow-hidden group shadow-xl"
        >
          <div className="absolute top-0 left-0 right-0 h-[1.5px] bg-gradient-to-r from-transparent via-white/30 to-transparent pointer-events-none" />
          ...
          <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-2xl bg-[#64d2ff]/20 border border-[#64d2ff]/35 flex items-center justify-center text-[#64d2ff] mb-4 sm:mb-6 shadow-sm">
            <History size={22} />
          </div>

          <h3 className="text-lg sm:text-2xl font-extrabold text-white tracking-tight">Timeline Replay</h3>
          ...
          <Link
            to="/timeline"
            className="inline-flex items-center gap-1.5 text-xs font-bold text-[#64d2ff] hover:text-white mt-5 sm:mt-6 group-hover:translate-x-1 transition-all"
          >
        ...
        >
          ...
          <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-2xl bg-[#30d158]/20 border border-[#30d158]/35 flex items-center justify-center text-[#30d158] mb-4 sm:mb-6 shadow-sm">
            <FileSpreadsheet size={22} />
          </div>

          <h3 className="text-lg sm:text-2xl font-extrabold text-white tracking-tight">Audit-Ready Export</h3>
          <p className="text-xs sm:text-sm text-[#86868b] mt-1.5">
          ...
          <div className="mt-5 sm:mt-6 flex items-center gap-2">
            <span className="px-2.5 py-1 rounded-xl bg-white/[0.06] border border-white/10 text-[11px] font-semibold text-white">
              PDF
            </span>
            <span className="px-2.5 py-1 rounded-xl bg-white/[0.06] border border-white/10 text-[11px] font-semibold text-white">
              Excel .xlsx
          ...
          <Link
            to="/reports"
            className="inline-flex items-center gap-1.5 text-xs font-bold text-[#30d158] hover:text-white mt-5 sm:mt-6 group-hover:translate-x-1 transition-all"
          >
        ...
        >
          ...
          <div className="flex items-start justify-between mb-4 sm:mb-6 relative z-10">
            <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-2xl bg-[#0a84ff]/20 border border-[#0a84ff]/35 flex items-center justify-center text-[#0a84ff] shadow-sm">
              <Cloud size={22} />
            </div>
            <span className="px-2.5 py-0.5 sm:px-3 sm:py-1 rounded-full text-[10px] font-bold uppercase tracking-wider text-[#0a84ff] bg-[#0a84ff]/10 border border-[#0a84ff]/25">
              Secure Storage
            </span>
          </div>

          <h3 className="text-lg sm:text-2xl font-extrabold text-white tracking-tight relative z-10">Automatic Secure Backups</h3>
          <p className="text-xs sm:text-sm text-[#86868b] mt-1.5 max-w-md relative z-10">
            Always-on backup to the cloud with instant restore points and secure verification.
          </p>

          <div className="mt-5 sm:mt-6 flex flex-wrap gap-3 sm:gap-4 text-xs text-[#a1a1a6] relative z-10">
          ...
          <Link
            to="/backup"
            className="inline-flex items-center gap-1.5 text-xs font-bold text-[#0a84ff] hover:text-white mt-5 sm:mt-6 group-hover:translate-x-1 transition-all relative z-10"
          >
